...
%             dN3_dy = dN3_dxi * phys2para(1, 2) + dN3_deta * phys2para(2, 2);
            dN1_dx = TriangularBasis(1,1,0,qp(1,qua),qp(2,qua), n1, n2, n3);
            dN2_dx = TriangularBasis(2,1,0,qp(1,qua),qp(2,qua), n1, n2, n3);
            dN3_dx = TriangularBasis(3,1,0,qp(1,qua),qp(2,qua), n1, n2, n3);
            dN1_dy = TriangularBasis(1,0,1,qp(1,qua),qp(2,qua), n1, n2, n3);
            dN2_dy = TriangularBasis(2,0,1,qp(1,qua),qp(2,qua), n1, n2, n3);
            dN3_dy = TriangularBasis(3,0,1,qp(1,qua),qp(2,qua), n1, n2, n3);
        ...
        TriangularBasis(node,0,0,qp(1,qua),qp(2,qua), n1, n2, n3) * ...
        f_x(qp(1,qua),qp(2,qua));
                else
                    f_ele(aa) = f_ele(aa) +  wq(qua) * ...
        TriangularBasis(node,0,0,qp(1,qua),qp(2,qua), n1, n2, n3) * ...
        f_y(qp(1,qua),qp(2,qua));
